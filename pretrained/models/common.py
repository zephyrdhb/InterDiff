...
class GaussianSmearing(nn.Module):
    def __init__(self, start=0.0, stop=5.0, num_gaussians=50):
        ...
        # customized offset
        offset = torch.tensor([0,1,2,  2.5,  3, 3.5, 4, 4.5, 5, 5.5, 6, 6.5, 7,7.5,8])
    ...
    def forward(self, dist):
        ...
        return torch.exp(-torch.pow(dist, 2)) + 1e-8
...
def frag_context(h_protein, h_ligand, pos_protein, pos_ligand, batch_protein, batch_ligand):
